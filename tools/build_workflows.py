...
# example_inputs/*.png 就躺在**本仓库**里，所以链接指向本仓库自己的 raw ——
# 上游仓库改名或删档都不会让生成的工作流断图。
REPO_RAW = "https://raw.githubusercontent.com/kkqiu007/ComfyUI_Marquee_Director/refs/heads/main/"
...
- This pack, its nodes or these workflows: 本包是本地独立包 `ComfyUI_Marquee_Director`，
  已与上游仓库脱离，不向上游提 issue —— 问题直接改本地源码。
